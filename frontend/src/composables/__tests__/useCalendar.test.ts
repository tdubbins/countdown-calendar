...
describe('useCalendar Composable', () => {
  ...
  // Mock calendar summary for testing
  ...
  describe('loadCalendars', () => {
    describe('Successful load', () => {
      ...
      it('should convert Calendar to CalendarSummary', async () => {
        ...
        // CalendarSummary may include startDate and endDate (optional fields)
        // The important check is that required fields are present
      });
    });
