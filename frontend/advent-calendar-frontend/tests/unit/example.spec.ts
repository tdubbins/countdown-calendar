  ...
  describe('Form Validation', () => {
    describe('Title validation', () => {
      it('should require minimum 3 characters for title', async () => {
        ...
        if (titleField) {
          await titleField.vm.$emit('update:model-value', 'AB');
      ...
      it('should accept valid title (3-50 characters)', async () => {
        ...
        if (titleField) {
          await titleField.vm.$emit('update:model-value', 'Valid Title');
          await titleField.vm.$emit('blur');
          await nextTick();
      ...
      it('should reject titles longer than 50 characters', async () => {
        ...
        if (titleField) {
          ...
          await titleField.vm.$emit('update:model-value', longTitle);
          await titleField.vm.$emit('blur');
          await nextTick();
    ...
    describe('Date validation', () => {
      ...
      it('should reject past start dates in create mode', async () => {
        ...
        if (startDateField) {
          await startDateField.vm.$emit('update:model-value', '2020-01-01');
          await startDateField.vm.$emit('blur');
          await nextTick();
      ...
      it('should validate end date is after start date', async () => {
        ...
        if (startDateField && endDateField) {
          await startDateField.vm.$emit('update:model-value', '2025-12-25');
          await endDateField.vm.$emit('update:model-value', '2025-12-01');
          await endDateField.vm.$emit('blur');
          await nextTick();
      ...
      it('should validate duration does not exceed 31 days', async () => {
        ...
        if (startDateField && endDateField) {
          await startDateField.vm.$emit('update:model-value', '2025-12-01');
          await endDateField.vm.$emit('update:model-value', '2026-01-15'); // More than 31 days
          await endDateField.vm.$emit('blur');
          await nextTick();
    ...
    describe('Submit button state', () => {
      ...
      it('should enable submit button when form is valid', async () => {
        ...
        if (endDateField) {
          await endDateField.vm.$emit('update:model-value', '2025-12-25');
          await nextTick();
  ...
  describe('User Interactions', () => {
    ...
    it('should clear error messages when user starts typing', async () => {
      ...
      if (titleField) {
        ...
        // Start typing again
        await titleField.vm.$emit('update:model-value', 'ABC');
        await nextTick();
  ...
  describe('Duration Calculation', () => {
    ...
    it('should update duration when dates change', async () => {
      ...
      if (endDateField) {
        ...
        // Change end date
        await endDateField.vm.$emit('update:model-value', '2025-12-15');
        await nextTick();
